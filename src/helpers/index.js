...
const diagonalDictionaryTLBL = require('../dictionaries/diagonalTopRightBottomLeft.json');
...
const isSameDiagonal = (src, dest) => {
    return !!((diagonalDictionaryTLBR[src] && diagonalDictionaryTLBR[src][dest]) || (diagonalDictionaryTLBL[src] && diagonalDictionaryTLBL[src][dest]))
}
